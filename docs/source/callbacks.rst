...
Below is an example of a basic callback which prints the state of the loop at various points.
...
To write your own callback, subclass the Callback class and add your own code into the hooks.
